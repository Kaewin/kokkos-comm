...
kokkos() {
    if [ -d $HOME/repos/kokkos ]; then
        ...
        git clone git@github.com:kokkos/kokkos.git $HOME/repos/kokkos
    fi
...
#     else
#         # git clone git@github.com:kokkos/kokkos-comm.git $HOME/repos/kokkos-comm
#         git clone git@github.com:Kaewin/kokkos-comm.git $HOME/repos/kokkos-comm
#     fi
...
# Updated code to clone my specific fork and checkout the mpi_windows branch
kokkos-comm(){
    if [ -d $HOME/repos/kokkos-comm ]; then
        printf "'kokkos-comm' directory already exists.\n"
        ...
        # Clone and checkout the specific branch using SSH
        git clone -b mpi_windows git@github.com:Kaewin/kokkos-comm.git $HOME/repos/kokkos-comm
        cd $HOME/repos/kokkos-comm
    fi
